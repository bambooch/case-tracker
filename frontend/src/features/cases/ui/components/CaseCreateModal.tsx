      ...
      >
        <div className="p-6 sm:p-8">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.3em] text-orange-700">Create</p>
              <h2 className="mt-2 font-display text-3xl text-slate-950">New case</h2>
            </div>
            <button
              type="button"
          ...
          <form className="mt-6 space-y-4" onSubmit={(e) => void handleSubmit(e)}>
            <div className="space-y-1.5">
              ...
              <input
                ...
                type="text"
                placeholder="e.g. Contract review for Acme Ltd."
                value={draft.title}
